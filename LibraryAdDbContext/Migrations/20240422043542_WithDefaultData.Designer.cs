...
namespace LibraryAdDbContext.Migrations
{
    ...
    [Migration("20240422043542_WithDefaultData")]
            ...
            modelBuilder.Entity("Library.Entities.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Author = "Robin Sharma",
                            CreatedDate = new DateTime(2024, 4, 22, 10, 5, 41, 992, DateTimeKind.Local).AddTicks(241),
                            Description = "",
                        ...
                        new
                        {
                            Id = 2,
                            Author = "Bram Stocker",
                            CreatedDate = new DateTime(2024, 4, 22, 10, 5, 41, 992, DateTimeKind.Local).AddTicks(244),
                            Description = "",
                            Name = "Dracula",
                            Title = "Dracula"
                        });
            ...
            modelBuilder.Entity("Library.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 4, 22, 10, 5, 41, 992, DateTimeKind.Local).AddTicks(136),
